...
def show_image_with_boxes(img, objects, calib, show3d=True, depth=None):
    ...
    cv2.imwrite(os.path.join(dir, "2dbox.png"), img1)
    ...
    if show3d:
        ...
        cv2.imwrite(os.path.join(dir, "3dbox.png"), img2)
    if depth is not None:
        cv2.imshow("depth", depth)
        cv2.imwrite(os.path.join(dir, "depth.png"), depth)
...
def show_lidar_with_depth(
    ...
    if depth is not None:
        ...
        if save:
            data_idx = 0
            vely_dir = "/data/Dataset/OpenDataLab___KITTI_Object/dataset/training/save_result"
...
def show_lidar_on_image(pc_velo, img, calib, img_width, img_height):
    ...
    dir = "./imgs"
    cv2.imwrite(os.path.join(dir, "projection.png"), img)
    return img
...
def show_lidar_topview_with_boxes(pc_velo, objects, calib, objects_pred=None):
    ...
    dir = "./imgs"
    cv2.imwrite(os.path.join(dir, "top_image.png"), top_image)
    return top_image
